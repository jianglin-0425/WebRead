...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-footer"> \
                    <button id="session-timeout-dialog-登出" type="button" class="btn btn-default">' + opt.登出Button + '</button> \
            ...
            // "登出" button click
            $('#session-timeout-dialog-登出').on('click', function() {
                window.location = opt.登出Url;
            });
