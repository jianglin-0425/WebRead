...
if(/Android|Windows Phone|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)){
    ...
    if (id){Go('http://m.xbiquge.la/wapbook/'+id[1]+'_' + id[2] + '.html');}
...
function bqg_panel(){
//document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"http://so.xbiquge.la/cse/search\" id=\"sform\" target=\"_blank\"><input type=\"hidden\" name=\"s\" value=\"15629547599739040164\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"q\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"/modules/article/waps.php\" method=\"post\" id=\"sform\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"searchkey\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
